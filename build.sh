...
go get github.com/wrouesnel/dns-over-https-proxy
...
go build -v -o dns-over-https-proxy -a -tags netgo -installsuffix netgo src/github.com/wrouesnel/dns-over-https-proxy/*.go
